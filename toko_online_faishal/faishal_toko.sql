...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Nov 2021 pada 08.59
...
(30, 'Gitar 1', '231', 'guitar acoustic.jpg'),
...
(12, 'Faishal', 'faishal@gmail.com', '082190828901', 'Faishal', '827ccb0eea8a706c4c34a16891f84e7b', 'user');
...
--
ALTER TABLE `user`
  MODIFY `id_pengguna` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
